...
class Salary_TabbarControl extends StatefulWidget {
  const Salary_TabbarControl({super.key});

  @override
  State<Salary_TabbarControl> createState() => _Show_New_Real_EstateState();
}

class _Show_New_Real_EstateState extends State<Salary_TabbarControl> {
          ...
          children: [
            ...
            Container(
              ...
              child: TabBar(
                ...
                tabs: const [
                  Tab(text: 'Monthly Salary'),
                  Tab(text: 'Annually Salary'),
                ],
              ),
            ),
