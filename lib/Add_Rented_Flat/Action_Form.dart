...
class ActionForm extends StatefulWidget {
  ...
  const ActionForm({super.key,required this.propertyId});
...
class _ActionFormState extends State<ActionForm> {
  ...
  double rent = 0, security = 0, commission = 0, advance = 0, extra = 0;
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 16),
                _buildInputField("Commission", "e.g. 2000", commissionController, Icons.percent),
                const SizedBox(height: 16),
            ...
            child: ElevatedButton.icon(
              ...
              onPressed: _isSubmitting
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  print("Commission: ${commissionController.text}");
