...
class PropertyCompleteDetailPage extends StatefulWidget {
  final String propertyId;

  const PropertyCompleteDetailPage({super.key, required this.propertyId});

  @override
  State<PropertyCompleteDetailPage> createState() => _PropertyCompleteDetailPageState();
}

class _PropertyCompleteDetailPageState extends State<PropertyCompleteDetailPage> {
