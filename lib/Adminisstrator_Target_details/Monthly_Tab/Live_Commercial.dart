...
class MonthlyCommercial extends StatefulWidget {
  final String number;
  const MonthlyCommercial({super.key,required this.number});

  @override
  State<MonthlyCommercial> createState() =>
      _MonthlyCommercialState();
}

class _MonthlyCommercialState extends State<MonthlyCommercial> {
  late Future<List<MonthlyCommercialModel>> futureData;

  @override
  void initState() {
    super.initState();
    futureData = fetchMonthlyCommercial(widget.number);
  }
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => MonthluCommercialDetailScreen(c: b),
                      ),
                    );
                  },
                  child: Container(
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    b.residenceCommercial, // Commercial
  ...
  Widget _iconInfo(IconData icon, String text) {
    ...
    return Row(
      children: [
        Icon(icon, size: 16, color: Color(0xFF06B6D4)),
        const SizedBox(width: 4),
        Text(
          safe,
          style: TextStyle(
