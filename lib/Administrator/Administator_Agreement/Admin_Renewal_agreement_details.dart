...
class AdminRenewalAgreementDetails extends StatefulWidget {
  final RenewalAgreementData data;

  const AdminRenewalAgreementDetails({super.key, required this.data});
  ...
  @override
  State<AdminRenewalAgreementDetails> createState() =>
      _AdminRenewalAgreementDetailsState();
}

class _AdminRenewalAgreementDetailsState
    extends State<AdminRenewalAgreementDetails> {
    ...
    showDialog(
      ...
      builder: (_) => const Center(
        child: CircularProgressIndicator(
          color: AdminRenewalAgreementDetails.kPurple,
        ),
      ),
    );
      ...
      if (response.statusCode == 200 &&
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            ...
            backgroundColor: AdminRenewalAgreementDetails.kGreen,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: AdminRenewalAgreementDetails.kPurpleLight,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                  ...
                                  color:isDark? AdminRenewalAgreementDetails.kWhite : AdminRenewalAgreementDetails.kDarkText),
                            ),
                            Text(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AdminRenewalAgreementDetails.kGreenLight,
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(
                          color: AdminRenewalAgreementDetails.kGreen
                              .withOpacity(0.3),
                        ),
                      ),
                      child: Row(
                    ...
                    // Monthly Rent Field
                     Text(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w600,
                          color: isDark
                              ? AdminRenewalAgreementDetails.kWhite
                              : AdminRenewalAgreementDetails.kDarkText),
                    ),
                    const SizedBox(height: 8),
                    TextField(
                      ...
                      style:  const TextStyle(
                        color: AdminRenewalAgreementDetails.kPurple,// text color,
                        fontSize: 15,
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                            ...
                            borderSide: const BorderSide(
                                color:
                                AdminRenewalAgreementDetails.kPurpleBorder)),
                        ...
                        enabledBorder: OutlineInputBorder(
                            ...
                            borderSide: const BorderSide(
                                ...
                                AdminRenewalAgreementDetails.kPurpleBorder)),
                        filled: true,
                        fillColor: AdminRenewalAgreementDetails.kPurpleLight,
                      ),
                    ),
                    const SizedBox(height: 16),
                              ...
                              Theme(
                                data: Theme.of(ctx).copyWith(
                                  colorScheme: const ColorScheme.light(
                                    primary: AdminRenewalAgreementDetails.kPurple,
                                  ),
                                ),
                                child: child!,
                              ),
                    ...
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                        AdminRenewalAgreementDetails.kPurple,
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios,
              color: AdminRenewalAgreementDetails.kWhite),
          onPressed: () => Navigator.pop(context),
        ),
        title: Image.asset(AppImages.transparent, height: 40),
        centerTitle: true,
      ),
      //bottomNavigationBar: _buildHeaderSection(),
        ...
        children: [
          ...
          Container(
            ...
            child: const Row(
              children:  [
                Icon(Icons.circle,
                    color: AdminRenewalAgreementDetails.kGreen, size: 7),
                SizedBox(width: 5),
                Text(
                  'ACTIVE',
                  style: TextStyle(
          ...
          if (ownerImages.isNotEmpty) ...[
            ...
            Row(
              children: ownerImages
                ...
                final url =
                    '${AdminRenewalAgreementDetails._baseUrl}${entry.value}';
                return Expanded(
                  child: Padding(
                    padding: EdgeInsets.only(
        ...
        children: [
          Expanded(
            child: _InfoCard(
              ...
              iconColor: AdminRenewalAgreementDetails.kPurple,
              label: 'MONTHLY RENT',
              value: '₹${widget.data.monthlyRent}',
              valueColor: AdminRenewalAgreementDetails.kGreen,
            ),
          ),
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.location_on_outlined,
                    color: AdminRenewalAgreementDetails.kPurple, size: 20),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
                          color: AdminRenewalAgreementDetails.kDarkText),
                    ),
                  ],
                ),
              ),
            ...
            children: [
              Text('Owner Details',
                  style: TextStyle(
                      ...
                      color: AdminRenewalAgreementDetails.kDarkText)),
              Icon(Icons.shield_outlined,
                  color: AdminRenewalAgreementDetails.kPurpleAccent, size: 22),
            ],
          ),
          const SizedBox(height: 14),
          Row(
            children: [
              _AvatarImage(
                imageUrl: widget.data.ownerAadharFront.isNotEmpty
                    ? '${AdminRenewalAgreementDetails._baseUrl}${widget.data
                    .ownerAadharFront}'
                    : null,
                initials: widget.data.ownerName
                    ...
                    : 'O',
                bgColor: AdminRenewalAgreementDetails.kPurpleAccent,
              ),
            ...
            children: [
              _AvatarImage(
                ...
                initials: widget.data.tenantName
                    ...
                    : 'T',
                bgColor: AdminRenewalAgreementDetails.kPurple,
              ),
              const SizedBox(width: 14),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            colors: [
              AdminRenewalAgreementDetails.kPurple,
              AdminRenewalAgreementDetails.kPurpleAccent
            ],
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(14),
          border:
          Border.all(color: AdminRenewalAgreementDetails.kPurpleBorder),
        ),
        padding:
              ...
              child: Row(
                children: [
                  const Icon(Icons.phone_outlined,
                      color: AdminRenewalAgreementDetails.kPurple, size: 18),
  ...
  //           color: AdminRenewalAgreementDetails.kWhite, size: 20),
  //       label: const Text(
  //         'Renewal Agreement',
  //         style: TextStyle(
  //             fontSize: 15,
  ...
  //       ),
  //       style: ElevatedButton.styleFrom(
  //         backgroundColor: AdminRenewalAgreementDetails.kPurple,
  //         minimumSize: const Size(double.infinity, 52),
  //         shape: RoundedRectangleBorder(
  //             borderRadius: BorderRadius.circular(12)),
  //         elevation: 0,
