  ...
  pdf.addPage(
    pw.MultiPage(
      ...
      build: (context) => [
        ...
        pw.SizedBox(height: 12),
        clause('26. Disputes:', 'All disputes or legal matters arising out of this Leave & License shall be settled exclusively in the court that has lawful jurisdiction over the area in which the rented property is situated. Only the court designated by the Government for this locality shall have the authority to hear and decide such cases.'),
        pw.SizedBox(height: 12),
        clause('27. Digital Communication & E-Signature Validity:', 'Both parties agree that communication done through WhatsApp, Email, SMS, or any digital platform shall be considered valid. Digital signatures or scanned signatures shall be treated as legally binding under the Information Technology Act, 2000. (IPC 465, 471) (BNS 325(1), 327(2))'),
        pw.SizedBox(height: 12),
        clause('28. Fire Safety & Hazardous Materials Prohibition:', 'The Tenant shall not store flammable, chemical, explosive, or hazardous materials. Violation may attract action under IPC Section 285 and IPC Section 286, and may result in immediate termination.(IPC 285, 286) (BNS 281(2), 282)'),
        pw.SizedBox(height: 12),
        ...
        pw.SizedBox(height: 12),
        clause('30. Legal Issues or Police Cases:', 'If the Second Party/Tenant is involved in any police case or legal issue, the First Party/Landlord shall not be held responsible or liable for any consequences arising therefrom.'),
        pw.SizedBox(height: 12),
