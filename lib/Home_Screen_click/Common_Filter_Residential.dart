        ...
        child: Column(
          ...
          children: [
            ...
            ValueListenableBuilder(
              ...
              builder: (context, int selectedIndex, _) {
                return GridView.count(
                  ...
                  children: List.generate(rent.length, (index) {
                    final isSelected = selectedIndex == index;
                    final theme = Theme.of(context);
                    return GestureDetector(
                      onTap: () {
                        buyIndex.value = index;
                        print("Selected Option: ${rent[buyIndex.value]}");
                      },
                      child: Container(
            ...
            Container(
                ...
                child: Text('Choose Property Type',style: TextStyle(fontSize: 16,fontFamily: 'Poppins'),)),
                  ...
                  children: List.generate(timing.length, (index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        print("Selected Timing: ${timing[index]}");
                      },
                      child: Container(
                        alignment: Alignment.center,
            ...
            Container(
                padding: EdgeInsets.only(left: 5),
                child: Text('Choose Location',style: TextStyle(fontSize: 16,fontFamily: 'Poppins'),)),
            ...
            Container(
                padding: EdgeInsets.only(left: 5),
                child: Text('Choose Area',style: TextStyle(fontSize: 16,fontFamily: 'Poppins'),)),
                    ...
                    bhk.length,
                      ...
                      return GestureDetector(
                        onTap: () {
                          ...
                          print("Selected BHK: ${bhk[bhkIndex.value]}");
                        },
                        child: Container(
                          alignment: Alignment.center,
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    ...
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute
                                          (builder: (context) => Filter_View_Details(id: '${abc.data![len].id.toString()}',))
                                    );
                                  },
                                  child: Column(
                                    children: [
