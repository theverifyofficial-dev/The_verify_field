...
class Filter_View_Details extends StatefulWidget {
  String id;
  Filter_View_Details({super.key, required this.id});

  @override
  State<Filter_View_Details> createState() => _Filter_View_DetailsState();
}

class _Filter_View_DetailsState extends State<Filter_View_Details> {
