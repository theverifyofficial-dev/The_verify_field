...
import '../model/Expire_Agreement.dart' hide AgreementDate;
import 'package:http/http.dart' as http;
import '../model/Model_Renewal_agreement.dart';

class RenewalAgreementDetail extends StatefulWidget {
  final RenewalAgreementData data;

  const RenewalAgreementDetail({super.key, required this.data});
  ...
  @override
  State<RenewalAgreementDetail> createState() =>
      _RenewalAgreementDetailState();
}

class _RenewalAgreementDetailState
    extends State<RenewalAgreementDetail> {
    ...
    showDialog(
      ...
      builder: (_) => const Center(
        child: CircularProgressIndicator(
          color: RenewalAgreementDetail.kPurple,
        ),
      ),
    );
      ...
      if (response.statusCode == 200 &&
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            ...
            backgroundColor: RenewalAgreementDetail.kGreen,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: RenewalAgreementDetail.kPurpleLight,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                  ...
                                  color:isDark? RenewalAgreementDetail.kWhite : RenewalAgreementDetail.kDarkText),
                            ),
                            Text(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: RenewalAgreementDetail.kGreenLight,
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(
                          color: RenewalAgreementDetail.kGreen
                              .withOpacity(0.3),
                        ),
                      ),
                      child: Row(
                    ...
                    // Monthly Rent Field
                     Text(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w600,
                          color: isDark
                              ? RenewalAgreementDetail.kWhite
                              : RenewalAgreementDetail.kDarkText),
                    ),
                    const SizedBox(height: 8),
                    TextField(
                      ...
                      style:  const TextStyle(
                        color: RenewalAgreementDetail.kPurple,// text color,
                        fontSize: 15,
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                            ...
                            borderSide: const BorderSide(
                                color:
                                RenewalAgreementDetail.kPurpleBorder)),
                        ...
                        enabledBorder: OutlineInputBorder(
                            ...
                            borderSide: const BorderSide(
                                ...
                                RenewalAgreementDetail.kPurpleBorder)),
                        filled: true,
                        fillColor: RenewalAgreementDetail.kPurpleLight,
                      ),
                    ),
                    const SizedBox(height: 16),
                              ...
                              Theme(
                                data: Theme.of(ctx).copyWith(
                                  colorScheme: const ColorScheme.light(
                                    primary: RenewalAgreementDetail.kPurple,
                                  ),
                                ),
                                child: child!,
                              ),
                    ...
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                        RenewalAgreementDetail.kPurple,
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios,
              color: RenewalAgreementDetail.kWhite),
        ...
        children: [
          ...
          Container(
            ...
            child: const Row(
              children:  [
                Icon(Icons.circle,
                    color: RenewalAgreementDetail.kGreen, size: 7),
                SizedBox(width: 5),
                Text(
                  'ACTIVE',
                  style: TextStyle(
          ...
          if (ownerImages.isNotEmpty) ...[
            ...
            Row(
              children: ownerImages
                ...
                final url =
                    '${RenewalAgreementDetail._baseUrl}${entry.value}';
                return Expanded(
                  child: Padding(
                    padding: EdgeInsets.only(
        ...
        children: [
          Expanded(
            child: _InfoCard(
              ...
              iconColor: RenewalAgreementDetail.kPurple,
              label: 'MONTHLY RENT',
              value: '₹${widget.data.monthlyRent}',
              valueColor: RenewalAgreementDetail.kGreen,
            ),
          ),
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.location_on_outlined,
                    color: RenewalAgreementDetail.kPurple, size: 20),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
                          color: RenewalAgreementDetail.kDarkText),
                    ),
                  ],
                ),
              ),
            ...
            children: [
              Text('Owner Details',
                  style: TextStyle(
                      ...
                      color: RenewalAgreementDetail.kDarkText)),
              Icon(Icons.shield_outlined,
                  color: RenewalAgreementDetail.kPurpleAccent, size: 22),
            ],
          ),
          const SizedBox(height: 14),
          Row(
            children: [
              _AvatarImage(
                imageUrl: widget.data.ownerAadharFront.isNotEmpty
                    ? '${RenewalAgreementDetail._baseUrl}${widget.data
                    .ownerAadharFront}'
                    : null,
                initials: widget.data.ownerName
                    ...
                    : 'O',
                bgColor: RenewalAgreementDetail.kPurpleAccent,
              ),
            ...
            children: [
              _AvatarImage(
                ...
                initials: widget.data.tenantName
                    ...
                    : 'T',
                bgColor: RenewalAgreementDetail.kPurple,
              ),
              const SizedBox(width: 14),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            colors: [
              RenewalAgreementDetail.kPurple,
              RenewalAgreementDetail.kPurpleAccent
            ],
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(14),
          border:
          Border.all(color: RenewalAgreementDetail.kPurpleBorder),
        ),
        padding:
              ...
              child: Row(
                children: [
                  const Icon(Icons.phone_outlined,
                      color: RenewalAgreementDetail.kPurple, size: 18),
    ...
    return Container(
      ...
      child: ElevatedButton.icon(
        ...
        icon: const Icon(Icons.autorenew,
            color: RenewalAgreementDetail.kWhite, size: 20),
        label: const Text(
          'Renewal Agreement',
          style: TextStyle(
              fontSize: 15,
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: RenewalAgreementDetail.kPurple,
          minimumSize: const Size(double.infinity, 52),
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(12)),
          elevation: 0,
