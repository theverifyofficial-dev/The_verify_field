...
class AllAgreDetails extends StatefulWidget {
  final String agreementId;
  const AllAgreDetails({super.key, required this.agreementId});

  @override
  State<AllAgreDetails> createState() => _AgreementDetailPageState();
}

class _AgreementDetailPageState extends State<AllAgreDetails> {
