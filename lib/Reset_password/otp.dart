                ...
                child: Container(
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        const Text('Verification Code',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.white),),
                        const SizedBox(height: 20,),
                        const Text('Enter the verification code that we send on mobile after confirmation you can reset your password',style: TextStyle(fontSize: 18,color: Colors.white),),
