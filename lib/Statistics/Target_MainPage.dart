...
class MonthlyTargetResult {
  ...
  factory MonthlyTargetResult.fromRoot(Map<String, dynamic> root) {
...
// in _Target_MainPageState
  ...
  Future<MonthlyTargetResult> fetchMonthlyTargetForAgent({
    ...
    return MonthlyTargetResult.fromRoot(root);
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon:  Icon(
                PhosphorIcons.arrowClockwise(), color: Colors.white),
            onPressed: _fetchAll,
            tooltip: 'Refresh',
          ),
