...
class YearlyBookBuyScreen extends StatefulWidget {
  const YearlyBookBuyScreen({super.key});

  @override
  State<YearlyBookBuyScreen> createState() => _YearlyBookBuyScreenState();
}

class _YearlyBookBuyScreenState extends State<YearlyBookBuyScreen> {
  late Future<List<BookModel>> futureData;

  @override
  void initState() {
    super.initState();
    futureData = fetchBuyBookedBuildings();
  }
