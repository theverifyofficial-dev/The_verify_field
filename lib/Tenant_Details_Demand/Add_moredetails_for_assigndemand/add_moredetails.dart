...
class Add_Moredetails_for_assigndemand extends StatefulWidget {
  String iddd;
  String name_;
  String number_;
  String Pending_id;
  Add_Moredetails_for_assigndemand({super.key, required this.iddd, required this.name_, required this.number_, required this.Pending_id});

  @override
  State<Add_Moredetails_for_assigndemand> createState() => _Add_Moredetails_for_assigndemandState();
}

class _Add_Moredetails_for_assigndemandState extends State<Add_Moredetails_for_assigndemand> {
  ...
  String? _bhk;
  final List<String> _bhk1 = ['1 BHK','2 BHK','3 BHK', '4 BHK','1 RK','Commercial','Plot','Farms','Warehouse'];

  String? _buyrent;
  final List<String> _buyrent1 = ['Buy','Rent'];

  String? _selectedItem;
  final List<String> _items = ['SultanPur','ChhattarPur','Aya Nagar','Ghitorni'];
  ...
  void initState() {
    ...
    _name.text = widget.name_;
    _number.text = widget.number_;
