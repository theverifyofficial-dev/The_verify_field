...
class _Persnol_Assignd_Tenant_detailsState extends State<Persnol_Assignd_Tenant_details> {
  ...
  Future<List<Catid>> fetchData(id) async {
    var url = Uri.parse('https://verifyrealestateandservices.in/WebService4.asmx/display_assign_tenant_demand_by_feild_num_looking_location_?fieldworkar_number=$_num&looking_type=Re_Demand&location_=sultanpur');
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                  children: [
                                                    // Icon(Iconsax.sort_copy,size: 15,),
                                                    //SizedBox(width: 10,),
                                                    Text(""+abc.data![len].dates/*+abc.data![len].Building_Name.toUpperCase()*/,
                                                      style: TextStyle(
                                                          fontSize: 15,
                                                          color: Colors.black,
                                                          fontWeight: FontWeight.w500,
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                  children: [
                                                    // Icon(Iconsax.sort_copy,size: 15,),
                                                    //SizedBox(width: 10,),
                                                    Text(""+abc.data![len].times/*+abc.data![len].Building_Name.toUpperCase()*/,
                                                      style: TextStyle(
                                                          fontSize: 15,
                                                          color: Colors.black,
                                                          fontWeight: FontWeight.w500,
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              children: [
                                                // Icon(Iconsax.sort_copy,size: 15,),
                                                //w SizedBox(width: 10,),
                                                Text("[ Re Demand No = $displayIndex ]",/*+abc.data![len].Building_Name.toUpperCase()*/
                                                  style: TextStyle(
                                                      backgroundColor: Colors.red,
                                                      fontSize: 13,
                                                      color: Colors.white,
