...
class Filter_by_facility extends StatefulWidget {
  ...
  @override
  State<Filter_by_facility> createState() => _Filter_by_facilityState();
}

class _Filter_by_facilityState extends State<Filter_by_facility> {
  ...
  ValueNotifier<int> areaIndex = ValueNotifier(0);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
                ...
                child: Text('Choose Buy / Rent',style: TextStyle(fontSize: 16,color: Colors.white,fontFamily: 'Poppins'),)),
            ...
            Container(
                padding: EdgeInsets.only(left: 5),
                child: Text('Choose BHK',style: TextStyle(fontSize: 16,color: Colors.white,fontFamily: 'Poppins'),)),
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    ...
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Show_tenant_Demand_facility_Filter(BHK: '${BHK[BHKIndex.value]}', Buy_Rent: '${rent[buyIndex.value]}', Area: '${Area[areaIndex.value]}',)));

                  }, child: Text("Show Demand", style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold, ),
                ),
                ),
              ),
            ),
...
class Show_tenant_Demand_facility_Filter extends StatefulWidget {
  final String BHK;
  final String Buy_Rent;
  final String Area;
  const Show_tenant_Demand_facility_Filter({Key? key, required this.BHK,required this.Buy_Rent,required this.Area}) : super(key: key);

  @override
  State<Show_tenant_Demand_facility_Filter> createState() => _Show_tenant_Demand_facility_FilterState();
}

class _Show_tenant_Demand_facility_FilterState extends State<Show_tenant_Demand_facility_Filter> {

  Future<List<Catid>> fetchData(bbhhkk,buy_rent,plc) async {
    var url = Uri.parse("https://verifyrealestateandservices.in/WebService4.asmx/filter_tenant_demand_by_bhk_buy_rent_area_?bhk=$bbhhkk&Buy_rent=$buy_rent&place=$plc");
          ...
          children: [
            Container(
              child: FutureBuilder<List<Catid>>(
                  future: fetchData(widget.BHK,widget.Buy_Rent,widget.Area),
                  builder: (context,abc){
