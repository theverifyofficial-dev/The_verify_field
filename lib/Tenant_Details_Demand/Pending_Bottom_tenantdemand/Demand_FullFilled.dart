...
class Fullfilled_demand extends StatefulWidget {
  const Fullfilled_demand({super.key});

  @override
  State<Fullfilled_demand> createState() => _Fullfilled_demandState();
}
                            ...
                            return GestureDetector(
                              onTap: () async {
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute
                                      (builder: (context) => Details_Fullfilled_Demand(id: '${abc.data![len].id.toString()}',))
                                );
                              },
                              child: Column(
                                children: [
