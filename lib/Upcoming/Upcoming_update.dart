...
class UpcomingUpdate extends StatefulWidget {
  final int propertyId;

  const UpcomingUpdate({super.key, required this.propertyId});

  @override
  State<UpcomingUpdate> createState() => _UpdateRealEstatePropertyState();
}

class _UpdateRealEstatePropertyState extends State<UpcomingUpdate> {
