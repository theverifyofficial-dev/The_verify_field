...
class AddedDetails extends StatefulWidget {
  final int id;
  const AddedDetails({super.key, required this.id});

  @override
  State<AddedDetails> createState() => _UpcomingDetailsPageState();
}

class _UpcomingDetailsPageState extends State<AddedDetails> {
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => MultiImg(propertyId: property_id ),
                  ),
                );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                sectionCard(context, "Property Information", [
                  ...
                  infoRow(context, "Kitchen", data['kitchen']),
                  infoRow(context, "Bathroom", data['bathroom']),
                ...
                sectionCard(context, "Owner Details", [
                  ...
                  infoRow(context, "CareTaker Name ", data['care_taker_name']),
      ...
      bottomNavigationBar: buildGradientButton(context, widget.id),
    );
  }
