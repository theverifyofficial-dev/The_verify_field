...
//                 boxShadow: [
//                   BoxShadow(
//                     color: isDark ? Colors.black.withOpacity(0.4) : Colors.black
//                         .withOpacity(0.1),
//                     blurRadius: 15,
...
//                   _buildInfoItem(Icons.email, "E-mail",
//                       _user!.email.isNotEmpty ? _user!.email : "Not provided"),
//                   _buildInfoItem(Icons.phone, "Phone number", _user!.number),
//                   _buildInfoItem(Icons.account_box_rounded, "Account Holder",
//                       _user!.aadhar),
//                   _buildInfoItem(
//                       Icons.business, "Office address", _user!.location),
//                   _buildInfoItem(
//                       Icons.vertical_align_bottom, "App Version", "3.0"),
//                 ],
//               ),
//             ),
//             const SizedBox(height: 20),
...
//               child: _buildIntegratedThemeToggle(
//                   context, isDark, themeSwitcher),
//             ),
//             const SizedBox(height: 20),
...
//   }
//
//   Widget _buildIntegratedThemeToggle(BuildContext context, bool isDark,
//       ThemeSwitcher? themeSwitcher) {
//     return LayoutBuilder(
//       builder: (context, constraints) {
//         final tabWidth = (constraints.maxWidth - 0) /
//             2; // Adjusted for tighter padding
//         return Stack(
//           children: [
...
//                 InkWell(
//                   onTap: () {
//                     if (isDark && themeSwitcher != null) themeSwitcher
//                         .toggleTheme();
//                   },
//                   borderRadius: BorderRadius.circular(20),
...
//                             color: !isDark ? Colors.white : (isDark
...
//                             color: isDark ? Colors.white : (isDark ? Colors
//                                 .grey[600] : const Color(0xFF9CA3AF))),
//                         const SizedBox(width: 4),
//                         Text(
//                           "Dark",
//                           style: TextStyle(
...
//             ),
//             child: Icon(
//                 icon, color: isDark ? Colors.white70 : const Color(0xFF6B7280),
//                 size: 18),
//           ),
